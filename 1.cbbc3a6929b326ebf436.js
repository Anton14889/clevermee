...
/* harmony import */ var ng_rating_bar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ng-rating-bar */ "./node_modules/ng-rating-bar/fesm5/ng-rating-bar.js");
...
var BadgeListComponent = /** @class */ (function () {
    function BadgeListComponent(resourceLoadsService) {
    ...
    BadgeListComponent.prototype.open = function (e) {
        this.openTooltip.emit(e.target.getBoundingClientRect());
    };
    BadgeListComponent.prototype.close = function () {
...
var NumberIndicatorComponent = /** @class */ (function () {
    function NumberIndicatorComponent(resourceLoadsService) {
        this.resourceLoadsService = resourceLoadsService;
        this.openTooltip = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        this.closeTooltip = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
    }
    NumberIndicatorComponent.prototype.ngOnChanges = function () {
        if (this.value > 100) {
            this.value = 'plus100';
        }
    };
    NumberIndicatorComponent.prototype.open = function (e) {
        this.openTooltip.emit(e.target.getBoundingClientRect());
    };
    NumberIndicatorComponent.prototype.close = function () {
        this.closeTooltip.emit(true);
    };
